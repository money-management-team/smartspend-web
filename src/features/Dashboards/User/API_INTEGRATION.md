...
- يضاف `Accept-Language` تلقائيًا من لغة `i18next` الحالية.
- جميع النصوص الجديدة في الواجهات المتصلة تستخدم `useTranslation`، ويجب دمج ملفي `locales/ar.json` و`locales/en.json` المرفقين مع ملفات الترجمة في المشروع.
